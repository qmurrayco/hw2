...
{
    book *bk = new book(isbn_, author_, prodName_, price_, qty_);
...
{
     clothing *clth = new clothing(size_, brand_, prodName_, price_, qty_);
...
{
    movie *mv = new movie(rating_, genre_, prodName_, price_, qty_);
